...
router.get('/:clientNumber', async (req, res) => {
...
router.get('/agreements/:planId', async (req, res) => {
...
router.put('/agreements/:planId/:clientAgreementId', async (req, res) => {
...
router.get('/all/:clientNumber', async (req, res) => {
  const { clientNumber } = req.params;
