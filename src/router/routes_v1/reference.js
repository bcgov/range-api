  ...
  asyncMiddleware(async (req, res) => {
    try {
      ...
      const response = {
        ...
        LIVESTOCK_IDENTIFIER_TYPE: livestockIdentifierType || {
          error: errorMessage,
        },
        MINISTER_ISSUE_ACTION_TYPE: ministerIssueActionType || {
          error: errorMessage,
        },
        ...
        PLANT_COMMUNITY_ELEVATION: plantCommunityElevation || {
          error: errorMessage,
        },
        PLANT_COMMUNITY_ACTION_TYPE: plantCommunityActionType || {
          error: errorMessage,
        },
        MONITORING_AREA_HEALTH: monitoringAreaHealth || { error: errorMessage },
        MONITORING_AREA_PURPOSE_TYPE: monitoringAreaPurposeType || {
          error: errorMessage,
        },
        MANAGEMENT_CONSIDERATION_TYPE: managementConsiderationType || {
          error: errorMessage,
        },
        ADDITIONAL_REQUIREMENT_CATEGORY: additionalRequirementCategory || {
          error: errorMessage,
        },
