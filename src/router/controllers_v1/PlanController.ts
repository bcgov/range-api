...
import GrazingScheduleEntry from '../../libs/db2/model/grazingscheduleentry.js';
import HayCuttingScheduleEntry from '../../libs/db2/model/haycuttingscheduleentry.js';
import InvasivePlantChecklist from '../../libs/db2/model/invasiveplantchecklist.js';
import ManagementConsideration from '../../libs/db2/model/managementconsideration.js';
import MinisterIssue from '../../libs/db2/model/ministerissue.js';
import MinisterIssueAction from '../../libs/db2/model/ministerissueaction.js';
...
import IndicatorPlant from '../../libs/db2/model/indicatorplant.js';
import MonitoringArea from '../../libs/db2/model/monitoringarea.js';
import PlantCommunityAction from '../../libs/db2/model/plantcommunityaction.js';
...
export default class PlanController {
  ...
  static async downloadPDF(req, res) {
    ...
    res.setHeader('Content-disposition', `attachment; filename=${plan.agreementId}.pdf`);
