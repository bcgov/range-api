...
export default class PlanScheduleController {
  ...
  static async store(req, res) {
    ...
    try {
      ...
      const isGrazing = agreement.agreementTypeId === 1 || agreement.agreement_type_id === 2;
      const isHayCutting = agreement.agreementTypeId === 3 || agreement.agreement_type_id === 4;
  ...
  static async update(req, res) {
    ...
    try {
      ...
      console.log('Schedule Entries:', JSON.stringify(scheduleEntries));
      const ops = scheduleEntries.map((entry) => {
        ...
        if (isGrazing) {
          ...
          console.log('IsGrazing' + JSON.stringify(data));
          return entry.id
          ...
          console.log('IsHayCutting' + JSON.stringify(data));
          return entry.id
