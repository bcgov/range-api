// @ts-nocheck
import { errorWithCode, logger } from './bcgov-shim.js';
import axios from 'axios';

export class Mailer {
  constructor(
    authenticationURL = process.env.CHES_AUTHENTICATION_URL,
    emailServiceURL = process.env.CHES_EMAIL_SERVICE_URL,
    clientId = process.env.CHES_CLIENT_ID,
    clientSecret = process.env.CHES_CLIENT_SECRET,
    enabled = process.env.CHES_ENABLED,
  ) {
