exports.up = async (knex) => {
  await knex.raw(`
    ...
    ALTER TABLE haycutting_schedule_entry ADD CONSTRAINT haycutting_schedule_entry_livestock_type_id_foreign FOREIGN KEY (livestock_type_id) REFERENCES ref_livestock(id);
