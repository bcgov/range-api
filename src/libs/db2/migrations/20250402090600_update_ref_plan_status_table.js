exports.up = async (knex) => {
  ...
  await knex('ref_plan_status').where('id', 8).update({ name: 'Wrongly Made Stands - SA' });
  ...
  await knex('ref_plan_status').where('id', 20).update({ name: 'Stands Review - SA' });
  await knex('ref_plan_status').where('id', 21).update({ name: 'Stands - Not Reviewed - AH' });
  ...
  await knex('ref_plan_status').where('id', 24).update({ name: 'Submitted as Mandatory - SA' });
