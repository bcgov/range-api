...
const updateUser = async data => {
  ...
  for (let index = 0; index < data.length; index++) {
    ...
    const zoneDescription = range_zone_full
      ? range_zone_full.trim()
